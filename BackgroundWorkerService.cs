...
public class BackgroundWorkerService :BackgroundService
{
    ...
    public BackgroundWorkerService(ILogger<BackgroundWorkerService> logger, IServiceScopeFactory serviceScopeFactory, IOptions<JobSettings> options)
    {
        _logger = logger;
    ...
    protected async override Task ExecuteAsync(CancellationToken stoppingToken)
    {
        while (!stoppingToken.IsCancellationRequested)
        {
            ...
            await orderService.SyncProjects();
            await orderService.SyncWBS();
